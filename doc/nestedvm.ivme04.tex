...
The Runtime class does the work that the operating system usually does. Conceptually the Runtime class can be though of as the operating system and it’s subclasses (translated binaries and the interpreter) the CPU. The Runtime fulfills 5 primary goals:
